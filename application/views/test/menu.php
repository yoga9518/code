    ...
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li<?php if($act==0){?> class="active"<?php } ?>>
                <a href="<?php echo base_url();?>index.php/admin/c_admin/index"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
            </li>
            <li>
            ...
            <li <?php if($act==2){?> class="active"<?php } ?>>
                <a href="<?php echo base_url();?>index.php/admin/c_admin/tabel"><i class="fa fa-table fa-fw"></i> Tables</a>
            </li>
            <li>
